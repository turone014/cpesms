<?php
include 'connections/executeaddslot.php';
...
<body class="dark-edition">
    ...
    -->
            <?php $active ='addslot';  include 'include/sidebar.php';?>
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center" style="justify-content: flex-end;">
                            ...
                            <button
                                onclick="window.open('https://drive.google.com/file/d/1kVNheaof9OEdtG_f342KGy6jauLec5IV/view?usp=sharing')"
                                class="btn btn-info" type="submit" style="
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header card-header-warning">
                                                <h4 class="card-title">Adding of Slot Form</h4>
                                                <p class="card-category">Please upload your form in PDF format.</p>

                                            </div>
                                            <div class="card-body">

                                                <form action="addslot.php" id="myForm" method="post"
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" class="form-control inputFileVisible"
                                                                    placeholder="Upload your Form Here">
