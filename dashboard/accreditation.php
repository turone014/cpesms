<?php
include 'connections/executeaccred.php';
...
<body class="dark-edition">
    ...
    -->
            <?php $active ='accreditation';  include 'include/sidebar.php';?>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header card-header-warning">
                                                <h4 class="card-title">Accreditation Form</h4>
                                                <p class="card-category">Please upload your form in PDF format.</p>
                                                
                                            </div>
                                            <div class="card-body">
                                            
                                                <form action="accreditation.php" id="myForm" method="post" enctype="multipart/form-data">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" class="form-control inputFileVisible"
                                                                    placeholder="Upload your Accreditation Form Here">
