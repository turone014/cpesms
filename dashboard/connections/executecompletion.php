...
$sql = "SELECT * FROM complete_form_std";
...
if(isset($_POST['savess']))
{
  ...
  echo '}, 1000);</script>';
		...
		{
			$sql = "INSERT INTO complete_form_std (studentnumber,name,size,idstd,std_name,std_middle,std_last,status_id) VALUES('$stdnumber', '$filename','$size','$id','$firstname','$middlename','$lastname',0)";
...
{
	$id = $_GET['file_id'];
	$sql = "SELECT * FROM complete_form_std WHERE id=$id";
	$result = mysqli_query($con,$sql);
